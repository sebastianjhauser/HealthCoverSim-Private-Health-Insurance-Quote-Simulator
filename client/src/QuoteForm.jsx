...
// Used in a few places below - Applicant 2 only applies to Couple/Family.
...
// Shared by both age checks below, so the 18-100 rule only lives in one place.
...
function validate(body) {
    ...
    if (!isValidAge(body.applicant1_age)) {
    errs.push('Applicant 1 age must be between 18 and 100.')
    }
    if (!isSingle && !isValidAge(body.applicant2_age)) {
...
async function handleSubmit(e) {
    ...
    applicant2_age: isSingle ? null : Number(form.applicant2_age),
